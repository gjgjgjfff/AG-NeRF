...
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "1"  # 0表示第一个GPU，1表示第二个GPU，以此类推
import time
import numpy as np
import shutil
import torch
...
from AGNeRF.render_ray import render_rays
...
from AGNeRF.criterion import Criterion
...
from AGNeRF.data_loaders.create_training_dataset import create_training_dataset

from AGNeRF.Position_Encoding import *
...
def train(args):
    ...
    # Create AG-NeRF model
    model = AGNeRFModel(args, load_opt=not args.no_load_opt, load_scheduler=not args.no_load_scheduler)
    if args.local_rank == 0:    
        print('model.feature_net:\n',model.feature_net)
        print('model.net_coarse:\n',model.net_coarse)
        print('model.net_fine:\n',model.net_fine)
        ...
        for train_data in train_loader:
            ...
            if args.local_rank == 0:
                ...
                if global_step % 10000 == 0:
                    time_all.end_time()
                    time_all.spent_time(global_step)
